    ...
    <div>
      <main className="flex flex-col justify-center">
        <div className="flex flex-col justify-center mt-5">
          ...
          <div className="bg-[rgba(240,242,254,1)] flex flex-col md:flex-row mt-10 justify-center relative items-center p-4 md:p-10 ml-4 md:ml-36 mr-1 md:mr-36 gap-4 md:gap-16 rounded-2xl md:rounded-3xl">
            <form>
              ...
              <div className="flex flex-col justify-center items-start relative gap-3 pt-6">
                ...
                <input
                  className="bg-[rgba(255,255,255,1)] text-[rgba(29,33,48,1)] font-medium text-xs w-[250px] md:w-[512px] h-8 pl-3 rounded-md"
                  type="text"
                  id="email"
                ...
                />
                <textarea
                  className="bg-[rgba(255,255,255,1)] text-[rgba(29,33,48,1)] text-left relative font-normal text-xs w-[250px] md:w-[512px] h-8 pl-3 rounded-md"
                  id=""
                  cols="30"
                  rows="50"
                >
                ...
                <button className="bg-[rgba(29,33,48,1)] text-center w-[250px]  md:w-[512px] h-8 rounded-md text-xs text-[rgba(255,255,255,1)]">
                  Send
                </button>
              </div>
            </form>
